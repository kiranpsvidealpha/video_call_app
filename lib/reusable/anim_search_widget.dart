// ignore_for_file: prefer_typing_uninitialized_variables, library_private_types_in_public_api, prefer_if_null_operators
...
import '../mainApp/controllers/chats_controller.dart';
import 'colors.dart';
...
class AnimSearchBar extends StatefulWidget {
  ...
  const AnimSearchBar({
    ...
    this.textFieldColor = white,

    /// choose your custom color for the search when it is expanded
    this.searchIconColor = black,

    /// choose your custom color for the search when it is expanded
    this.textFieldIconColor = black,
...
///chatsController.toggle - 0 => false or closed
///chatsController.toggle 1 => true or open
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: AnimatedContainer(
        duration: Duration(milliseconds: widget.animationDurationInMilli),
        height: 48.0,
        width: (chatsController.toggle == 0) ? 48.0 : widget.width,
        curve: Curves.easeOut,
        decoration: BoxDecoration(
          /// can add custom  color or the color will be white
          color: chatsController.toggle == 1 ? widget.textFieldColor : widget.color,
          ...
          children: [
            ...
            AnimatedPositioned(
              ...
              child: AnimatedOpacity(
                opacity: (chatsController.toggle == 0) ? 0.0 : 1.0,
                duration: const Duration(milliseconds: 200),
                child: Container(
                  padding: const EdgeInsets.all(8.0),
                  decoration: BoxDecoration(
                    /// can add custom color or the
                    borderRadius: BorderRadius.circular(30.0),
                  ),
            ...
            AnimatedPositioned(
              duration: Duration(milliseconds: widget.animationDurationInMilli),
              left: (chatsController.toggle == 0) ? 20.0 : 40.0,
              curve: Curves.easeOut,
              top: 11.0,
              ...
              child: AnimatedOpacity(
                ...
                child: Container(
                  ...
                  child: TextField(
                    ...
                    style: widget.style ?? const TextStyle(color: black),
                    cursorColor: black,
            ...
            Material(
              color: chatsController.toggle == 0 ? widget.color : widget.textFieldColor,
              borderRadius: BorderRadius.circular(30.0),
              child: IconButton(
                splashRadius: 19.0,
                icon: widget.prefixIcon != null
                    ? chatsController.toggle == 1
                        ? Icon(
                        ...
                        : widget.prefixIcon!
                    : Icon(
                        chatsController.toggle == 1 ? Icons.arrow_back_ios : Icons.search,
                        // search icon color when closed
                        color: chatsController.toggle == 0 ? widget.searchIconColor : widget.textFieldIconColor,
                        size: 25.0,
                      ),
                onPressed: () {
                  setState(
                    () {
                      ...
                      if (chatsController.toggle == 0) {
                        chatsController.expandableSearchBar.value = true;
                        chatsController.toggle = 1;
                        setState(() {
